            ...
            <v-layout row wrap >
              <table  class="v-datatable v-table dark my-5" id=""  border=1>
                ...
                <tbody>
                  ...
                  <td class="nopad" v-if="report.PP1_Not_Updated!=0"><router-link :to="{ path: 'office_not_statred_district/'+report.id}" title="Click to See Office list">{{ report.PP1_Not_Updated }}</router-link></td>
                  <td class="nopad" v-else>{{ report.PP1_Not_Updated }}</td>
