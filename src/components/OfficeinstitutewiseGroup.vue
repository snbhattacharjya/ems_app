    ...
    <v-container fluid>
      <section id="report">
        ...
        <v-layout row wrap >
          ...
          <v-flex xs12 >
            <h1 class="headline">Office Institute wise Group Status Report(Male) </h1>
            <v-layout row wrap >
              <table  class="v-datatable v-table dark my-3" id=""  border=1>
                <thead>
                <tr>
                <th width="5%" ><strong>Sl.<br> No</strong></th>
                <th width="20%"><strong>Office Institute</strong></th>
          ...
          <v-flex xs12 >
            <h1 class="headline">Office Institute wise Group Status Report(Female) </h1>
            <v-layout row wrap >
              <table  class="v-datatable v-table dark my-3" id=""  border=1>
                <thead>
                <tr>
